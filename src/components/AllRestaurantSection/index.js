...
class AllRestaurantSection extends Component {
  ...
  onChangeSearchInput = e => {
    this.setState({searchInput: e.target.value, isSearchResultsList: true})
  }
  ...
  renderRestaurantListView = () => {
    ...
    const searchResultsList = restaurantList.filter(eachSearch =>
    ...
    return (
      <>
        ...
        <p className="fav-restaurants">Search Your Restaurant here</p>
        <hr className="hr-line" />
        {isSearchResultsList ? (
          <ul className="restaurant-list">
            {searchResultsList.map(restaurant => (
